...
<?php endforeach; ?>
    ...
    <br>
    <ul class="inline pushright" align="center">
      <li ><a class="btn inverse" href="<?php echo site_url('invoice/destroy_cart')?>">กลับสู่หน้าหลัก</a></li>
      <li><a class="btn" href="<?php echo site_url('invoice/print')?>" target="_blank">Print</a></li>
    </ul>
</body>
</html>
